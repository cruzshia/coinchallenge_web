...
var newChallengeGroupEpic = function newChallengeGroupEpic(action$, state$) {
  return action$.pipe((0, _reduxObservable.ofType)(_action.CREATE_CHALLENGE_GROUP), (0, _operators.take)(1), (0, _operators.filter)(function () {
    ...
    payload.agent = payload.agent === '' ? '0xa99CeB4475670cCDF31a78232bfA585848598cBA' : payload.agent;
    return (0, _rxjs.from)((_contract$methods = contract.methods).createChallengeGroup.apply(_contract$methods, _toConsumableArray(Object.values(payload))).send({
      from: address
    }, function (_err, hash) {
