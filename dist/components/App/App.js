...
var supportRegex = _common.supportLang.join('|');
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement(_styles.MuiThemeProvider, {
        ...
        path: "/:lng(".concat(supportRegex, ")?"),
        exact: true,
        component: Landing
      }), _react.default.createElement(_reactRouterDom.Route, {
        path: "/:lng(".concat(supportRegex, ")/create"),
        exact: true,
        component: _CreateChallengeGroup.default
      }), _react.default.createElement(_reactRouterDom.Route, {
        path: "/:lng(".concat(supportRegex, ")/challenge/:groupId/:address"),
