...
var ChallengeCard = _react.default.memo(function (_ref) {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(StyledTtitleCtr, null, _react.default.createElement(StyledTitle, null, invalidAddress ? '' : name), invalidAddress || url === '' ? _react.default.createElement(Logo, {
    src: _logo.default
